...
public class Clouds extends AbstractGameObject{
	...
	private void init() {
		...
		regClouds.add(Assets.instance.levelDecoration.cloud04);
	...
	private Cloud spawnCloud() {
		...
		pos.x = length + 10; // end of level + 10
		pos.y += 4.5f; // base height
		pos.y += MathUtils.random(0.0f, 2.0f) * (MathUtils.randomBoolean() ? 1 : -1); // random additional position
